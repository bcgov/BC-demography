---
title: "BC_demography_01_median_age_group"
author: "Martin Monkman"
date: "January 08, 2020"
output: html_document
---

## Plot the median age_group of British Columbia & Canada, 1971-2019

### data

Source:
Statistics Canada, CANSIM 
[Population estimates on July 1st, by age_group and sex](https://www150.statcan.gc.ca/t1/tbl1/en/tv.action?pid=1710000501)

Table: 17-10-0005-01 (formerly CANSIM 051-0001)

The source file contains population for Canada, the provinces and territories, by age_group (and age_group group), and by sex, for the years 1976-2019 (as of this writing).
...
data_age_groupdistrib_BC_2016$age_group.num <- gsub(" years", "", data_age_groupdistrib_BC_2016$age_group)
data_age_groupdistrib_BC_2016$age_group.num <- gsub(" year", "", data_age_groupdistrib_BC_2016$age_group.num)
data_age_groupdistrib_BC_2016$age_group.num <- as.integer(gsub(" and over", "", data_age_groupdistrib_BC_2016$age_group.num))

unique(data_age_groupdistrib_BC_2016$age_group.num)
