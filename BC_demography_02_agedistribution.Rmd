...
plot_smooth_years <- ggplot(data_agedistrib_BC_2016, aes(x=age.num, y=Value)) +
  ...
  annotate("text", x=55, y=73000, label = "2016", colour =  "#234275", fontface = 2) +
  annotate("text", x=40, y=24000, label = "1971", colour =  "#234275", fontface = 2)


plot_smooth_years <- plot_smooth_years +
  theme_BCStats +
  scale_colour_manual(values=palette_BCStats) +
  labs(title = "British Columbia, Age distribution, 1971 & 2016",
       y = "population", x = NULL,
       caption ="Source: Statistics Canada, CANSIM Table 051-0001") +
  scale_x_continuous(breaks = seq(0, 100, 10)) +
  scale_y_continuous(limits = c(0, 90000), breaks = seq(0, 90000, by = 10000),
...
plot_smooth_pct <- ggplot(data_agedistrib_BC_2016, aes(x=age.num, y=year_pct)) +
  geom_smooth(span = 0.3, se = FALSE, colour = "#234275") +
  geom_smooth(data = data_agedistrib_BC_1971, span = 0.3, se = FALSE, colour = "#E3A82B") +
  annotate("text", x=55, y=1.6, label = "2016", colour =  "#234275", fontface = 2) +
  annotate("text", x=10, y=2.1, label = "1971", colour =  "#234275", fontface = 2)
...
plot_smooth_years2 <- ggplot(data_agedistrib_BC_2016, aes(x=age.num, y=Value)) +
  ...
  annotate("text", x=36, y=82000, label = "2041", colour =  "#234275", fontface = 2) +
  annotate("text", x=40, y=59000, label = "2016", colour =  "#234275", fontface = 2) +
  annotate("text", x=40, y=24000, label = "1971", colour =  "#234275", fontface = 2)
...
plot_smooth_pct2 <- ggplot(data_agedistrib_BC_2016, aes(x=age.num, y=year_pct)) +
  ...
  annotate("text", x=84, y=1.0, label = "2041", colour =  "#234275", fontface = 2) +
  annotate("text", x=12, y=1.25, label = "2016", colour =  "#234275", fontface = 2) +
  annotate("text", x=10, y=2.05, label = "1971", colour =  "#234275", fontface = 2)
