...
# save the plot as a png file
ggsave("plot_smooth_years.png", width=9, height=6)
...
# save the plot as a png file
ggsave("plot_smooth_years_proj.png", width=9, height=6)
...
# save the plot as a png file
ggsave("plot_smooth_pct_proj.png", width=9, height=6)
...
ch_65plus +
  theme_BCStats +
#  scale_colour_manual(values=palette_BCStats) +
  labs(title = "British Columbia: population, ages 65+ & 85+",
...
#  ) +
  ...
  annotate("text", x=2030, y=500000, label = "80+", colour =  "#E3A82B", fontface = 2) +
#  
  # projection box
